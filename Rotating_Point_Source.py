...
U = 3.0 # total number of revolutions, hence 12 sec in total
...
tr1 = Trajectory()
tmax = U/rps # 12 sec
delta_t = 1./rps/16.0 # 16 steps per revolution (1/rps=4sec, which means 4 sec per rev, then divided by 16, therefore the delta is 1/4 sec per 1/16 rev)
for t in arange(0, tmax*1.001, delta_t):
    i = t* rps * 2 * pi #angle in a step
